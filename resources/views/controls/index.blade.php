...
<div class="px-6 py-8 text-white">
        ...
        <div class="flex flex-wrap gap-4">
            ...
            <div>
                ...
                <select name="site_id" onchange="this.form.submit()"
                        class="w-48 bg-[rgb(44,44,44)] text-white px-3 py-2 rounded-md border border-gray-500 shadow-sm focus:outline-none">
    ...
    <form id="controlsForm" method="POST" action="{{ route('controls.update', ['id' => $device->id]) }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="bg-[rgb(44,44,44)] p-6 rounded-2xl shadow">
                    <div class="flex justify-center items-center bg-[#2C2C2C] p-6 rounded-2xl w-full max-w-xs mx-auto flex-col">
                        ...
                        <input type="range" name="temperature" min="10" max="30" value="{{ $device->temperature }}"
                ...
                <div class="bg-[rgb(44,44,44)] p-6 rounded-2xl shadow">
                    ...
                    <input type="range" name="shades" id="shadesSlider" min="0" max="100" value="{{ $device->shades }}"
            ...
            <div class="bg-[#2c2c2c] rounded-xl p-6 text-white row-span-2">
                ...
                <div class="flex flex-col items-center mb-6">
                    ...
                    <input type="range" name="dimmer" min="0" max="100" value="{{ $device->dimmer }}"
                ...
                <div class="flex flex-col items-center mb-6">
                    ...
                    <div class="relative w-full max-w-sm h-10 mb-2">
                        ...
                        <input type="range" name="color_temperature" min="1000" max="10000" value="{{ $device->color_temperature }}"
                ...
                <div class="flex flex-col items-center">
                    ...
                    <input type="color" name="rgb_color" value="{{ $device->rgb_color ?? '#ff0000' }}"
        ...
        <div class="mt-6">
            <button type="submit"
                    class="px-6 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">Update</button>
        </div>
    </form>
</div>
