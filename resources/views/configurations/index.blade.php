        ...
        <table class="w-full text-sm text-left">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-700 hover:bg-[#2a2a2a] transition">
                    ...
                    {{-- Mode avec icône Lucide --}}
                    <td class="px-6 py-4 flex items-center gap-2">
                        @if($config->mode === 'Eco')
                            <i data-lucide="leaf" class="w-5 h-5 text-green-400"></i> Eco</span>
                        @elseif($config->mode === 'Performance')
                            <i data-lucide="zap" class="w-5 h-5 text-red-400"></i> Performance</span>
                        @elseif($config->mode === 'Standard')
                            <i data-lucide="gauge" class="w-5 h-5 text-with-400"></i> Standard</span>
                        @else
                            {{ $config->mode }}
                        @endif
                    </td>
